Rails.application.configure do
  ...
  if ENV["HEROKU_APP_NAME"]
    ENV["STATIC_ASSET_ROOT"] = "https://#{ENV['HEROKU_APP_NAME']}.herokuapp.com" unless ENV.include?("STATIC_ASSET_ROOT")
  ...
  config.action_controller.asset_host = ENV["STATIC_ASSET_ROOT"] || ENV["GOVUK_ASSET_ROOT"]
